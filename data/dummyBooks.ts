...
export const dummyBooks: Book[] = [
  ...
  { 
    id: 5, title: "Financial Accounting", author: "Jerry J. Weygandt", faculty: "FEB", price: 120000, condition: "Bagus", imageUrl: "https://images.unsplash.com/photo-1554252116-431bf85994ac?q=80&w=800&auto=format&fit=crop", description: "Full daging buat akuntansi dasar.",
  ...
  { 
    id: 7, title: "Pengantar Ilmu Hukum", author: "Peter Mahmud Marzuki", faculty: "Hukum", price: 75000, condition: "Seperti Baru", imageUrl: "https://covers.openlibrary.org/b/isbn/9789791486538-L.jpg", description: "Cover masih mulus banget.",
